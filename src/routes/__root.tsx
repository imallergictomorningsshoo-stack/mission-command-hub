...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bhoonidi GCS — CanSat Ground Control Station" },
      {
        name: "description",
        content:
          "Ground Control Station for Team Bhoonidi's CanSat at the Malaysian Rocket Competition.",
      },
      { name: "author", content: "Team Bhoonidi" },
      { property: "og:title", content: "Bhoonidi GCS — CanSat Ground Control Station" },
      {
